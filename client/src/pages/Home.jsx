  ...
  return (
    <div>
      ...
      {/* <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <div className="text-gary-400 text-xs sm:text-sm">
          RentNest is the best place to find your next perfect place to live.
          <br />
      ...
      {/* Listing results */}
      <div className="bg-white max-w-8xl mx-auto p-3 px-10 flex flex-col gap-8 my-10">
