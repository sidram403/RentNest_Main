...
const Home = () => {
  ...
  return (
    <div>
      ...
      <div className=" relative justify-center gap-6 text-center items-center py-12 md:py-24 px-3 max-w-6xl mx-auto flex flex-col md:flex-row z-10 ">
      ...
      {/* Listing results */}
      <div className="bg-slate-200 max-w-8xl mx-auto p-3 px-3 md:px-10 flex flex-col gap-8 my-10 relative">
