...
const Profile = () => {
  ...
  return (
    <div className="bg-white">
      <div className="p-3 mx-auto max-w-7xl flex flex-col sm:flex-row">
        ...
        <div className="flex-1 my-7 p-3 sm:my-36 sm:p-10">
          <button
            onClick={handleShowListings}
            className="bg-primary text-white w-full rounded-lg p-3 uppercase text-center hover:opacity-95"
          >
