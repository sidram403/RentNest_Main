          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2">
              <input
                ...
                max="10"
                required
                className="p-3 border border-gray-300 rounded-lg text-black bg-white"
                onChange={handleChange}
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <div className="flex flex-col items-center">
                <p className="text-black"> Deposite price</p>
            ...
            {formData.offer && (
              <div className="flex items-center gap-2">
                ...
                <div className="flex flex-col items-center">
                  ...
                  {formData.type === "rent" && (
                    <span className="text-xs text-black">(₹ 1st month)</span>
                  )}
                </div>
              </div>
            )}
